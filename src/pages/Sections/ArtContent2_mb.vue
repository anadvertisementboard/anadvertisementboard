...
<template>
  <div >
    ...
    <div class="content-container  text-left">
      <h3 class="titleclass">{{artTitle}}</h3>
      ...
      <p class="firstclass">
        现任资助人： <span  class="addrclass">{{currentpatron}}</span>
      </p>
      <p class="firstclass">
      ...
      <div class="firstclass buyclass">
        <textarea placeholder="插入新广告内容： （本广告牌字数限制：12个中文字符/24个字符）" ref="initname" class="initNameclass" cols="60" rows="6"></textarea>
     ...
     <div class="firstclass funbtnclass">
      <textarea placeholder="插入新广告内容： （本广告牌字数限制：12个中文字符/24个字符）" ref="newName" class="initNameclass" cols="60" rows="6"></textarea>
    ...
    <p>
      <a href="https://github.com/anadvertisementboard/anadvertisementboard">https://github.com/anadvertisementboard/<br/>anadvertisementboard</a>
    </p>
    </div>
    <tips></tips>
  </div>
